...
echo <<<EOP
{$p_str['autho_user']}: {$_login->user_u} <font color="gray">(p2 ID: 9999999999)</font><br>
{$p_htm['auth_cookie']}モリタポ残高: 99999 （<a href="http://find.moritapo.jp/moritapo/amount.php" target="_blank">モリタポ通帳</a>）<br><br>
<br>
